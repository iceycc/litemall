...
* MySQL数据访问地址`jdbc:mysql://198.181.58.233:3306/litemall`
...
spring:
  datasource:
    druid:
      url:  jdbc:mysql://198.181.58.233:3306/litemall?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC&allowPublicKeyRetrieval=true&verifyServerCertificate=false&useSSL=false
